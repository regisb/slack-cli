...
class EmojiTests(unittest.TestCase):
    ...
    def test_emojize(self):
        self.assertEqual("Merry christmas 🎄!", emoji.emojize("Merry christmas :christmas_tree:!"))
        self.assertEqual("Merry christmas :🎄!", emoji.emojize("Merry christmas ::christmas_tree:!"))
        self.assertEqual("::🎄 tricky stuff!", emoji.emojize(":::christmas_tree: tricky stuff!"))

    def test_emojize_verbatim_text(self):
        self.assertEqual("`Merry christmas :christmas_tree:!`", emoji.emojize("`Merry christmas :christmas_tree:!`"))
